...
export default function GroupsIncomeStatement() {
  ...
  return (
    <div>
      Groups : <Link  to="/groupsincomeexpense"><b>Balance Sheet</b></Link> | {" "}   
      <Link  to="/groupsincomeexpense"><b>Income Statement</b></Link> <br/> 
      Accounts : <Link  to="/groupsincomeexpense"><b>Balance Sheet</b></Link>| {" "} 
      <Link  to="/groupsincomeexpense"><b>Income Statement</b></Link> <br/> 
      <center><b>Manage Chart of Accounts : Groups Income Statement</b></center>
