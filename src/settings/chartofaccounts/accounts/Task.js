...
function Task({id, account_name,supergroup, account_type, isgroup, issubgroupof, issubgroupofname, cashflowstatement, completed}) {
    ...
    <div className={`task ${checked && 'task--borderColor'}`}>
      ...
      {open.edit &&
        <EditTask 
          ...
          toEditCashflowstatement={cashflowstatement}
          open={open.edit}
          id={id} />
      }
